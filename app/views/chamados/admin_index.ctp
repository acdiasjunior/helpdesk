...
<script type="text/javascript">
    $("#flex").flexigrid({
        ...
        colModel : [
            ...
            {display: 'Responsável ID', name : 'Responsavel.id', width : 150, sortable : true, align: 'left', hide: true},
            {display: 'Responsável', name : 'Responsavel.nome', width : 150, sortable : true, align: 'left'},
            {display: 'Usuário', name : 'Usuario.nome', width : 150, sortable : true, align: 'left'},
